...
>
    ...
    <button
        ...
        class="fixed bottom-6 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-600 text-white shadow-lg hover:bg-indigo-700 transition-colors"
    >
    ...
    <div
        x-show="panelOpen"
        x-cloak
        class="fixed bottom-6 right-6 z-50 w-[calc(100vw-3rem)] max-w-md overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800"
    >
        <div class="flex items-center justify-between bg-indigo-600 px-4 py-3 text-sm font-semibold text-white">
            ...
            <button type="button" @click="panelOpen = false; clearInterval(interval)" class="flex h-6 w-6 items-center justify-center rounded-md text-lg leading-none hover:bg-white/10">&times;</button>
        </div>

        <div class="grid h-[620px] grid-rows-[auto_1fr_auto]">
