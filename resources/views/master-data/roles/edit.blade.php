...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mt-2">Edit Role</h2>
    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update role details and RBAC permissions.</p>
</div>

<div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 sm:p-8">
    <form method="POST" action="{{ route('master-data.roles.update', $role) }}">
        @csrf
        @method('PUT')
