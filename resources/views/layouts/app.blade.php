...
<body class="font-sans antialiased text-gray-900 bg-gray-50 dark:text-gray-100 dark:bg-gray-900 overflow-x-hidden">
    ...
    <div
        ...
        <aside
            ...
            :style="sidebarCollapsed ? 'width: 72px' : 'width: 275px'"
            ...
            <nav x-ref="sidebarNav" @scroll="localStorage.setItem('sidebarScrollTop', $el.scrollTop)" class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="https://kerjaajadulu.com" target="_blank" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors relative group/item" :class="{ 'justify-center px-0': sidebarCollapsed }">
                    ...
                    <svg x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-100" class="w-3.5 h-3.5 ml-auto shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: {{ $isActive('employees.*') ? 'true' : 'false' }} || localStorage.getItem('sidebar_group_employees') === 'true' }">
                    <button @click="open = !open; localStorage.setItem('sidebar_group_employees', open)" class="flex items-center justify-between w-full px-3 py-2 text-xs font-semibold uppercase tracking-wider transition-colors {{ $isActive('employees.*') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300' }}" :class="{ 'justify-center px-0 uppercase-none': sidebarCollapsed }">
                        ...
                        <svg x-show="!sidebarCollapsed" class="w-3.5 h-3.5 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- Operation and Construction Group --}}
                <div x-data="{ open: {{ $isActive('operation-construction.*') ? 'true' : 'false' }} || localStorage.getItem('sidebar_group_operation_construction') === 'true' }">
                    <button @click="open = !open; localStorage.setItem('sidebar_group_operation_construction', open)" class="flex items-center justify-between w-full px-3 py-2 text-xs font-semibold uppercase tracking-wider transition-colors {{ $isActive('operation-construction.*') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300' }}" :class="{ 'justify-center px-0 uppercase-none': sidebarCollapsed }">
                        <span x-show="!sidebarCollapsed">Operation & Construction</span>
                        <svg x-show="!sidebarCollapsed" class="w-3.5 h-3.5 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Operation & Construction</div>
                    </button>
                    <div x-cloak x-show="open" x-collapse>
                        <a href="{{ route('operation-construction.overview') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('operation-construction.overview') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Overview</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Overview</div>
                        </a>
                        <a href="{{ route('operation-construction.projects.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('operation-construction.projects.*') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Projects</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Projects</div>
                        </a>
                    </div>
                </div>

                {{-- Marketing and Sales Group --}}
                <div x-data="{ open: {{ $isActive('marketing-sales.*') ? 'true' : 'false' }} || localStorage.getItem('sidebar_group_marketing_sales') === 'true' }">
                    <button @click="open = !open; localStorage.setItem('sidebar_group_marketing_sales', open)" class="flex items-center justify-between w-full px-3 py-2 text-xs font-semibold uppercase tracking-wider transition-colors {{ $isActive('marketing-sales.*') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300' }}" :class="{ 'justify-center px-0 uppercase-none': sidebarCollapsed }">
                        <span x-show="!sidebarCollapsed">Marketing & Sales</span>
                        <svg x-show="!sidebarCollapsed" class="w-3.5 h-3.5 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Marketing & Sales</div>
                    </button>
                    <div x-cloak x-show="open" x-collapse>
                        <a href="{{ route('marketing-sales.sales-performance') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('marketing-sales.sales-performance') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Sales Performance</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Sales Performance</div>
                        </a>
                        <a href="{{ route('marketing-sales.marketing-performance') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('marketing-sales.marketing-performance') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Marketing Performance</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Marketing Performance</div>
                        </a>
                        <a href="{{ route('marketing-sales.leads.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('marketing-sales.leads.*') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Leads</span>
                            <span x-show="!sidebarCollapsed" class="ml-auto rounded-full bg-indigo-100 px-2 py-0.5 text-[10px] font-semibold text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-300">CRUD</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Leads</div>
                        </a>
                        <a href="{{ route('marketing-sales.survey-customers.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('marketing-sales.survey-customers.*') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Survey Customer</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Survey Customer</div>
                        </a>
                        <a href="{{ route('marketing-sales.closing-customers.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('marketing-sales.closing-customers.*') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Closing Customer</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Closing Customer</div>
                        </a>
                        <a href="{{ route('marketing-sales.project-stocks.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('marketing-sales.project-stocks.*') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                            <span x-show="!sidebarCollapsed">Project Stock (Property)</span>
                            <div x-show="sidebarCollapsed" x-cloak class="absolute left-full ml-2 px-2 py-1 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium whitespace-nowrap opacity-0 group-hover/item:opacity-100 pointer-events-none transition-opacity z-50">Project Stock</div>
                        </a>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ $isActive('leave-requests.*', 'master-data.leave-types', 'leave-settings.*', 'leave-management.holidays.*') ? 'true' : 'false' }} || localStorage.getItem('sidebar_group_leave_management') === 'true' }">
                    ...
                    <div x-cloak x-show="open" x-collapse>
                        ...
                        <a href="{{ route('leave-settings.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('leave-settings.*') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3M5 12h2m10 0h2M12 5v2m0 10v2" />
                            </svg>
                ...
                <div x-data="{ open: {{ $isActive('master-data.levels', 'master-data.job-positions', 'master-data.religions', 'master-data.contract-types', 'master-data.education-types', 'master-data.family-types', 'master-data.relationships', 'master-data.document-types', 'master-data.shifts', 'master-data.approval-workflows', 'master-data.roles', 'master-data.modules') ? 'true' : 'false' }} || localStorage.getItem('sidebar_group_reference') === 'true' }">
                    ...
                    <div x-cloak x-show="open" x-collapse>
                        ...
                        <a href="{{ route('master-data.religions') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors relative group/item {{ $isActive('master-data.departments') ? "$activeNested $activeNestedHover" : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100' }}" :class="{ 'justify-center px-0': sidebarCollapsed }">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M12 3l7 7-7 7-7-7 7-7z" />
                            </svg>
        ...
        {{-- Main content area --}}
        <div data-main-content class="flex-1 flex flex-col min-h-screen min-w-0 transition-all duration-200" :style="'padding-left: ' + (sidebarCollapsed ? '72px' : '275px')">
            {{-- Top navbar --}}
